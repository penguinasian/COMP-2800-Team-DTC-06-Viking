...
function readPopularRoutesName(id) {
    ...
    firebase.auth().onAuthStateChanged(function (user) {
        ...
        .get().then(function (result) {
            ...
            add_RoutesDetail(doc.id, doc.data().ROUTE_MAP_LINK, doc.data().ROUTE_LENGTH, doc.data().ROUTE_DIFFICULTY, doc.data().ROUTE_DURATION, doc.data().ROUTE_ELEV_UP, doc.data().ROUTE_DESC, doc.data().ROUTE_NAME);
